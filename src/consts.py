...
helpMsg = """help - [
            <builtin function>:
                ...
                run(string) - run a ThinkLang file: Run("file_name")
...
help_dict = {
    "clear": {"args": "", "text": "clear the screen", "returns": "null"},
    "help": {"args": "", "text": "print this message", "returns": "string"},
    "help_for": {
        "args": "function_name",
    ...
    "exit": {"args": "", "text": "exit the script", "returns": "null"},
    "print": {
        "args": "string/object",
    ...
    "get_now": {"args": "", "text": "get the current time", "returns": "int"},
    "get_env": {
        "args": "string",
    ...
    "random": {"args": "", "text": "get a random number", "returns": "int"},
    "rand_int": {"args": "min, max", "text": "get a random integer", "returns": "int"},
    "rand_seed": {"args": "int", "text": "set the random seed", "returns": "null"},
    "rand_pick": {
        "args": "list",
    ...
    "run": {"args": "string", "text": "run a ThinkLang file", "returns": "null"},
    "error": {
        "args": "string",
...
╚══██╔══╝██║  ██║██║████╗  ██║██║ ██╔╝██║     ██╔══██╗████╗  ██║██╔════╝ 
   ...
   ╚═╝   ╚═╝  ╚═╝╚═╝╚═╝  ╚═══╝╚═╝  ╚═╝╚══════╝╚═╝  ╚═╝╚═╝  ╚═══╝ ╚═════╝ 
         ...
         >> Shoving AI where it absolutely doesn't belong <<
"""
